...
GDAS=/scratch4/BMC/gmtb/mid_tier/vx_data/point/raw/gdas
GDAS_NC=/scratch4/BMC/gmtb/mid_tier/vx_data/point/proc/gdas
...
for PBFILE in `ls ${GDAS}/2016*/*prepbufr.nr`
do

...
vars.1='28.2 + 55.8 * exp(0.1813 * (TMPsfc-273.15-30))'
...
*         scale.1='-80 -65 1'
         scale.2='100 1000 50'
         cntlev='80 90 100'
         'colormaps  -map rainbow -l ' scale.r
...
*         'd 'vars.1
         ...
         'set string 1 c'
         'set strsiz 0.12'
         'draw string 2.75 1.8 'stime' for 'storms.s' - 'fhr' hr fcst'
